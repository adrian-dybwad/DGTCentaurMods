...
#
# Usage notes:
# - Pass --dry-run to print intended actions without executing them.
# - The run() helper executes commands directly (no eval) and prints a
#   shell-escaped preview in dry-run mode. Prefer calling it as: run cmd arg1 arg2 ...
