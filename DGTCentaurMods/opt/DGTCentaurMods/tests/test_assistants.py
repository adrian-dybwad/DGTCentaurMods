...
class TestAssistantConfig(unittest.TestCase):
    ...
    def test_config_defaults(self):
        ...
        """
        from DGTCentaurMods.assistants.base import AssistantConfig
...
class TestSuggestionType(unittest.TestCase):
    ...
    def test_suggestion_types_exist(self):
        ...
        """
        from DGTCentaurMods.assistants.base import SuggestionType
...
class TestSuggestion(unittest.TestCase):
    ...
    def test_piece_type_suggestion(self):
        ...
        """
        from DGTCentaurMods.assistants.base import Suggestion, SuggestionType
...
class TestHandBrainAssistant(unittest.TestCase):
    ...
    def test_init_with_config(self):
        ...
        """
        from DGTCentaurMods.assistants.hand_brain import HandBrainAssistant, HandBrainConfig
