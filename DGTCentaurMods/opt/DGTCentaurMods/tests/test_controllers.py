...
class TestGameControllerBase(unittest.TestCase):
    ...
    def test_cannot_instantiate_abstract_class(self):
        ...
        """
        from DGTCentaurMods.controllers.base import GameController
...
class TestLocalController(unittest.TestCase):
    ...
    def test_init_creates_inactive_controller(self):
        ...
        """
        from DGTCentaurMods.controllers.local import LocalController
...
class TestRemoteController(unittest.TestCase):
    ...
    def test_init_creates_inactive_controller(self):
        ...
        Failure: Controller starts in wrong state.
        """
        from DGTCentaurMods.controllers.remote import RemoteController
    ...
    def test_client_type_unknown_initially(self):
        ...
        """
        from DGTCentaurMods.controllers.remote import RemoteController, CLIENT_UNKNOWN
    ...
    def test_set_client_type_hint(self):
        ...
        """
        from DGTCentaurMods.controllers.remote import RemoteController, CLIENT_MILLENNIUM
...
class TestControllerManager(unittest.TestCase):
    ...
    def test_init_no_controllers(self):
        ...
        """
        from DGTCentaurMods.controllers.manager import ControllerManager
