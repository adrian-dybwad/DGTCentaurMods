...
Usage:
    python3 tools/dev-tools/sniffers/chessnut_ble.py
    python3 tools/dev-tools/sniffers/chessnut_ble.py --scan-time 15
    python3 tools/dev-tools/sniffers/chessnut_ble.py --connect-timeout 20
    python3 tools/dev-tools/sniffers/chessnut_ble.py --list-all
    python3 tools/dev-tools/sniffers/chessnut_ble.py --name "Chessnut"
    python3 tools/dev-tools/sniffers/chessnut_ble.py --address AA:BB:CC:DD:EE:FF
...
Examples:
    ...
    # Custom scan time
    python3 tools/dev-tools/sniffers/chessnut_ble.py --scan-time 20
"""
    )
